...
def calculate_C(c_d, b_st, n, t_ps):
    # Correctly implementing the C formula based on provided equation
...
def topology(num_cars, sumo_config_file, flood_type, duration, rate_mbps, unicast=True,
    ...
    info("*** Creating Links\n")
    for car in net.cars:
        print(f"Configuring mesh with freq={5180}, channel={38}, ht_capab={car.wintfs[0].ht_capab}")
        ...
        net.addLink(car, intf=car.wintfs[0].name, mode='ac', cls=mesh, ssid='mesh-ssid', channel=38, frequency=5180)
